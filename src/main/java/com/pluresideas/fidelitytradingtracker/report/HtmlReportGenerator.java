...
public class HtmlReportGenerator {
    ...
    public void generate(CalculationResults r, String outputPath) throws IOException {
        ...
        for (int i = 0; i < closedTrips.size(); i++) {
            ...
            chartDataJson.append(String.format(
                    ...
                    rt.getCloseDate(),
                    rt.getSymbol(),
                    rt.getRealizedPnL().setScale(2, RoundingMode.HALF_UP),
    ...
    private String getHtmlTemplate(CalculationResults r, String chartDataJson, List<RoundTrip> closedTrips) {
                            ...
                            <div class="col-12">
                                <div class="glass-card p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="text-white mb-0"><i class="fa-solid fa-list-check text-primary me-2"></i>Round-Trip Ledger ({{ledger_count}} Total Completed Trades)</h5>
        ...
        return template
                ...
                .replace("{{ledger_count}}", String.valueOf(r.roundTrips().size()))
